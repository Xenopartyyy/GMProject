...
@endforeach
  ...
  <button id="prev" class="absolute top-1/2 left-6 transform -translate-y-1/2 bg-green-500 text-white text-2xl p-4 rounded-full shadow-lg hover:bg-green-600 hover:scale-110 transition-all duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-400">
    &#10094;
</button>
<button id="next" class="absolute top-1/2 right-6 transform -translate-y-1/2 bg-green-500 text-white text-2xl p-4 rounded-full shadow-lg hover:bg-green-600 hover:scale-110 transition-all duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-400">
    &#10095;
</button>
...
<div class="bg-gradient-to-b from-neutral-50 to-emerald-50" style="font-family: Poppins;">
  <div class="text-5xl text-center text-emerald-400 font-bold py-5"><p data-aos="fade" data-aos-duration="800">Kelebihan Kami</p></div>
  <div class="grid grid-cols-1 md:grid-cols-4 gap-6 px-5 py-16 justify-items-center">
    ...
    <div  class="rounded-lg shadow-lg p-8 max-w-xs bg-white mx-auto">
      ...
      <p class="text-gray-600 text-justify">Produk berkualitas tinggi dengan harga kompetitif, memberikan nilai terbaik bagi pelanggan.</p>
    </div>
    <!-- Card 3 -->
    <div  class="rounded-lg shadow-lg p-8 max-w-xs bg-white mx-auto">
      <div class="text-center">
      ...
      <p class="text-gray-600 text-justify">Bahan pilihan dan proses ketat memastikan setiap produk awet dan nyaman dipakai.</p>
    </div>
    <!-- Card 4 -->
    <div  class="rounded-lg shadow-lg p-8 max-w-xs bg-white mx-auto">
      <div class="text-center">
      ...
      <p class="text-gray-600 text-justify">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eveniet, nostrum?</p>
    </div>
  </div>
</div>
{{-- PROS END --}}
