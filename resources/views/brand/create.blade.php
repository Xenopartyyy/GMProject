...
@section('kontendashboard')
    ...
    <div class="container mx-auto px-4">
        ...
        <form action="/dashboard/brand/store" method="POST" enctype="multipart/form-data" class="bg-white p-8 rounded-lg shadow-lg space-y-6">
            @csrf
            ...
            <div>
                ...
                <input type="text" name="deskripsibrand"
                    ...
                    value="{{ old('deskripsibrand') }}" placeholder="Masukkan Deskripsi Brand" />
