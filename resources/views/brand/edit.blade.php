...
<div class="container mx-auto px-4">
    ...
    <form action="{{ url('/dashboard/brand/' . $brand->id) }}" method="POST" enctype="multipart/form-data"
        ...
        <div>
            <div>
                <label for="media" class="block text-lg font-semibold text-gray-700">Media Halaman Brand</label>
                @if ($brand->media)
                <img src="{{ $brand->media }}" alt="Foto Toko" class="mb-2 h-32 w-32 object-cover">
                @endif
