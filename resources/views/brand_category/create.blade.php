...
@section('kontendashboard')
    ...
    <div class="container mx-auto px-4">
        <h1 class="text-center text-3xl font-bold text-gray-800 my-8">Tambah Kategori Brand Baru</h1>

        <form action="/dashboard/brandcategory/store" method="POST" enctype="multipart/form-data" class="bg-white p-8 rounded-lg shadow-lg space-y-6">
            @csrf
            ...
            <div>
                ...
                <textarea name="descatbrands" rows="4"
                    ...
                    placeholder="Masukkan Deskripsi Kategori Brand">{{ old('descatbrands') }}</textarea>
                @error('descatbrands')
                <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                @enderror
            </div>
