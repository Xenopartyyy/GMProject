            ...
            <div class="w-full md:w-1/2 flex flex-col items-center justify-start">
                <div class="relative">
                    ...
                    <div class="relative w-full h-full overflow-visible">
                        ...
                        <div id="carousel" class="relative w-[225px] h-[225px] sm:w-[250px] sm:h-[250px] md:w-[250px] md:h-[250px] lg:w-[300px] lg:h-[300px] xl:h-[450px]  xl:w-[450px]  overflow-hidden">
            ...
            <div class="w-full md:w-1/2 md:pl-6 mt-6 md:mt-0">
                ...
                <p class="text-gray-800 text-sm mb-4">
                    ...
                    @foreach (explode(',', $produk->ukbrg) as $ukuran)
                        <span class="inline-block bg-gray-200 text-gray-800 text-sm px-3 py-1 rounded-full mr-2">{{ $ukuran }}</span>
                    @endforeach
                </p>
                <p class="text-gray-800 text-sm mb-4 py-3">
                    <strong>Status Stok:</strong> 
                    <span class="text-white p-3 rounded-lg bg-{{ $produk->stokbrg === 'Ready' ? 'green-500' : 'red-500' }}">{{ $produk->stokbrg }}</span>
                </p>
