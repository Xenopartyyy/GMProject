...
<section id="tentang-kami" class="relative bg-gray-50 py-20 px-2">
    ...
    <div class="relative z-20 max-w-4xl mx-auto text-center text-white">
        <h2 class="text-6xl font-bold mb-8">Kopral</h2>
    </div>
...
<section>
	<div class="bg-gradient-to-b from-green-100 to-white py-24 px-6 lg:px-20">
...
{{-- <section id="marketplace" class="text-center py-20 bg-green-400">
    <a href="https://marketplace.link.to.kopral" target="_blank" class="text-white  bg-slate-600 py-4 px-10 rounded-full text-lg font-semibold shadow-lg hover:shadow-xl transform transition-all duration-300 hover:scale-105">
