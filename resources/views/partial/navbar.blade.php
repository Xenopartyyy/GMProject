<nav class="bg-info text-white shadow-lg" style="font-family: Poppins">  
    <div class="max-w-screen-xl mx-auto px-4 py-2 flex justify-between items-center">  
        ...
        <div class="hidden lg:flex space-x-8 items-center relative">  
            <a href="{{ url('/') }}" class="text-white hover:bg-green-500 rounded-lg px-3 py-2 transition duration-300">Beranda</a>  
            <div class="relative">  
                ...
                <ul id="brand-dropdown" class="absolute left-0 hidden bg-info rounded-lg shadow-lg mt-1 w-48 z-10">  
                    ...
                    <li><a href="{{ url('/kopral') }}" class="block px-4 py-2 text-gray-200 hover:bg-green-500">KOPRAL</a></li>  
                    <li><a href="{{ url('/hte') }}" class="block px-4 py-2 text-gray-200 hover:bg-green-500">HTE</a></li>  
                </ul>  
            </div>  
    ...
    <div id="mobile-menu" class="hidden lg:hidden bg-info">  
        <ul class="flex flex-col px-4 py-2 space-y-1">  
            ...
            <li><a href="{{ url('/katalog') }}" class="block text-white hover:bg-green-500 rounded-lg px-3 py-2 transition duration-300">Katalog Produk</a></li>  
            <li><a href="{{ url('/contact') }}" class="block text-white hover:bg-green-500 rounded-lg px-3 py-2 transition duration-300">Hubungi Kami</a></li>  
        </ul>  
    </div>  
</nav>  
