...
<div class="container mx-auto px-4">
    ...
    <form action="{{ url('/dashboard/perusahaan/' . $perusahaan->id) }}" method="POST" enctype="multipart/form-data"
        ...
        <div>
            ...
            <input type="text" name="slogan"
                ...
                value="{{ old('slogan', $perusahaan->slogan) }}" placeholder="Masukkan Slogan Perusahaan" />
            @error('slogan')
            <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div>
            ...
            <input type="text" name="descsingkat"
                ...
                value="{{ old('descsingkat', $perusahaan->descsingkat) }}"
