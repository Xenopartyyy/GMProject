...
<div class="container mx-auto px-4">
  ...
  <div class="flex justify-end mb-4">
    <a href="{{ url('dashboard/perusahaan/create') }}" class="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded">Tambah Perusahaan</a>
  </div>
        ...
        <tr class="text-center hover:bg-gray-100 border-b border-gray-300">
          ...
          <td class="py-2 px-4 border border-gray-300">
            <div class="flex justify-center space-x-2">
              <a href="{{ url('dashboard/perusahaan/' . $prsh->id . '/edit') }}" class="bg-yellow-400 hover:bg-yellow-500 text-white font-semibold py-1 px-2 rounded" title="Edit">
