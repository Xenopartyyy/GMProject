...
@section('kontendashboard')
    <div class="container mx-auto px-4">
        ...
        <form action="/dashboard/produk/store" method="POST" enctype="multipart/form-data" class="bg-white p-8 rounded-lg shadow-lg space-y-6">
            @csrf
            ...
            <div>
                ...
                <input type="file" name="fotobrg"
                    class="mt-2 w-full rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-400 focus:border-blue-400 transition duration-200 p-3 @error('fotobrg') is-invalid @enderror" />
                @error('fotobrg')
                <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                @enderror
            </div>
        ...
        <form action="/dashboard/produk/store" method="POST" enctype="multipart/form-data" class="bg-white p-8 rounded-lg shadow-lg space-y-6">
            ...
            <div>
                ...
                <input type="text" name="link_shopee"
                    ...
                    value="{{ old('link_shopee') }}" placeholder="Masukkan Link Barang di Shopee ( kosongkan jika tidak ada )" />
                @error('link_shopee')
                <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="text" name="link_tokped"
                    ...
                    value="{{ old('link_tokped') }}" placeholder="Masukkan Link Barang di Tokopedia ( kosongkan jika tidak ada )" />
                @error('link_tokped')
                <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="text" name="link_ttshop"
                    ...
                    value="{{ old('link_ttshop') }}" placeholder="Masukkan Link Barang di Tiktok Shop ( kosongkan jika tidak ada )" />
                @error('link_ttshop')
                <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                @enderror
            </div>
