...
<script>
    ...
    // Membuat elemen input gambar baru
    ...
    <input type="file" name="fotobrg[]"
        class="w-full rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-400 focus:border-blue-400 transition duration-200 p-3">
    <button type="button"
        class="remove-image bg-red-500 text-white px-3 py-2 rounded-md hover:bg-red-400 transition">Hapus</button>
    `;
    
    // Menambahkan elemen baru ke dalam container
    imageUploadContainer.appendChild(newImageField);
    
    // Menambahkan event listener untuk tombol Hapus pada input baru
    const removeButton = newImageField.querySelector('.remove-image');
    removeButton.addEventListener('click', () => {
    // Menghapus elemen input gambar baru
